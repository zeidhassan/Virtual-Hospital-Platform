...
export const getStatsAppointments = () =>
  apiClient.get('/admin/stats/appointments');
...
// Doctor list (for reassign modal)
export const getAllDoctors = () =>
  apiClient.get('/admin/doctor-time-slots', { params: { list_only: true } });
...
// Passwords (admin)
export const getAdminPasswords = () =>
  apiClient.get('/admin/passwords');
