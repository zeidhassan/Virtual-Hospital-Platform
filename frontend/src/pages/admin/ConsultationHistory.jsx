...
const AdminConsultationHistory = () => {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h1 className="text-xl font-bold text-text-primary">Consultation History</h1>
      </div>

      <Card>
        <CardHeader title="Search by Patient ID" icon={Search} />
        <div className="p-4 flex gap-2">
          ...
          />
          <Button onClick={handleSearch} size="sm">Load Timeline</Button>
        </div>
      </Card>
...
export default AdminConsultationHistory;
